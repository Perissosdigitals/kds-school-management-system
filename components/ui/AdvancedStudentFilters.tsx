    ...
    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 mb-6">
      ...
      <div className="flex items-center gap-4 mb-4">
        ...
        <button
          ...
          className={`flex items-center gap-2 px-4 py-2.5 rounded-lg font-bold transition-all ${isExpanded
        ...
        >
          ...
          {activeFiltersCount > 0 && (
            <span className={`text-xs font-black px-2 py-0.5 rounded-full ${isExpanded ? 'bg-white text-blue-600' : 'bg-blue-600 text-white'}`}>
              {activeFiltersCount}
            </span>
          )}
        </button>
        ...
        <div className="flex flex-wrap items-center gap-3 mt-4 pt-4 border-t border-slate-100">
          ...
          {filters.selectedClass && (
            <span className="inline-flex items-center gap-1 px-3 py-1 bg-purple-100 text-purple-700 rounded-full text-sm">
              ...
              {classes.find(c => c.id === filters.selectedClass)?.name || filters.selectedClass}
          ...
          {filters.selectedTeacher && (
            <span className="inline-flex items-center gap-1 px-3 py-1 bg-green-100 text-green-700 rounded-full text-sm">
              ...
              {(() => {
                const teacher = teachers.find(t => t.id === filters.selectedTeacher);
                return teacher ? `${teacher.firstName} ${teacher.lastName}` : 'Professeur';
              })()}
